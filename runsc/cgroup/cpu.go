...
func (s *CpuGroup) ApplyDir(path string, cgroup *Cgroup, pid int) error {
...
func (s *CpuGroup) SetRtSched(path string, cgroup *Cgroup) error {
...
func (s *CpuGroup) Set(path string, cgroup *Cgroup) error {
